  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-center">
        <div className="inline-flex p-1 bg-sand-200 dark:bg-stone-800 sepia:bg-amber-200 rounded-xl border border-sand-300 dark:border-stone-700 sepia:border-amber-400">
          <button
            onClick={() => setViewMode('single')}
            className={`px-6 py-2 text-sm font-medium rounded-lg transition-all duration-200 ${viewMode === 'single'
              ? 'bg-white dark:bg-stone-700 sepia:bg-amber-50 text-stone-900 dark:text-stone-100 sepia:text-amber-900 shadow-sm ring-1 ring-black/5 sepia:ring-amber-400'
                  ...
                  return (
                    <button
                      ...
                      className={`
                        ...
                        ${isDisabled ? 'opacity-50 grayscale cursor-not-allowed bg-sand-50 dark:bg-stone-900 sepia:bg-amber-100' : 'cursor-pointer hover:-translate-y-1'}
                        ${isSelected
                          ? 'bg-bronze-600 sepia:bg-amber-700 border-bronze-700 sepia:border-amber-800 text-white shadow-lg shadow-bronze-900/20'
                          : 'bg-white dark:bg-stone-800 sepia:bg-amber-50 border-sand-200 dark:border-stone-700 sepia:border-amber-300 text-stone-600 dark:text-stone-300 sepia:text-amber-800 hover:border-bronze-300 dark:hover:border-stone-500 sepia:hover:border-amber-400 hover:shadow-md'}
                      `}
                    >
                      <div className="flex justify-between w-full">
                        ...
                        <div className={`
                          ...
                          ${isSelected
                            ...
                            : 'bg-sand-100 dark:bg-stone-700 sepia:bg-amber-100 text-bronze-600 dark:text-bronze-400 sepia:text-amber-800 border border-sand-200 dark:border-stone-600 sepia:border-amber-400 group-hover:bg-sand-50'}
                        `}>
