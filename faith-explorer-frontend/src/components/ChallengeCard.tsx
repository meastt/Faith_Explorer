...
import { CheckCircle2, PenLine, Users, History } from 'lucide-react';
...
export function ChallengeCard({ challenge }: ChallengeCardProps) {
    ...
    const { activeChallenges, joinChallenge, completedActions, getActivityLogs } = useStore();
                ...
                <div className="p-5">
                    ...
                    {!isActive ? (
                        ...
                        <div className="space-y-4">
                            ...
                            {/* View Journal button when there are logs */}
                            {logs.length > 0 && (
                                <button
                                    onClick={() => setShowLogModal(true)}
