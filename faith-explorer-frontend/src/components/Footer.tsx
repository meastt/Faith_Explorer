    ...
    <footer className="mt-16 border-t border-sage-200 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          {/* About */}
          <div>
            <h3 className="font-bold text-sage-900 mb-3">About Faith Explorer</h3>
          ...
          {/* Features */}
          <div>
            <h3 className="font-bold text-sage-900 mb-3">Features</h3>
          ...
          {/* Contact & Legal */}
          <div>
            <h3 className="font-bold text-sage-900 mb-3">Support</h3>
            <div className="space-y-3">
              <a 
                href="mailto:support@faithexplorer.com" 
                className="flex items-center gap-2 text-sm text-sage-600 hover:text-primary-600 transition-colors"
              >
                <Mail className="w-4 h-4" />
                <span>support@faithexplorer.com</span>
              </a>
              <div className="flex flex-wrap gap-4 text-sm">
                <a href="#" className="text-sage-600 hover:text-primary-600 transition-colors">
                  Privacy Policy
                </a>
                <a href="#" className="text-sage-600 hover:text-primary-600 transition-colors">
                  Terms of Service
